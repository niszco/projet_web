 ...
 */
final class Version20231129180001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clothes (id INT AUTO_INCREMENT NOT NULL, brands_id INT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, description VARCHAR(255) NOT NULL, color VARCHAR(30) DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_3079B48CE9EEC0C7 (brands_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shoes (id INT AUTO_INCREMENT NOT NULL, brands_id INT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, description VARCHAR(255) NOT NULL, color VARCHAR(30) DEFAULT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_14CF8197E9EEC0C7 (brands_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE clothes ADD CONSTRAINT FK_3079B48CE9EEC0C7 FOREIGN KEY (brands_id) REFERENCES brand (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE clothes DROP FOREIGN KEY FK_3079B48CE9EEC0C7');
